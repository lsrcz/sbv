-----------------------------------------------------------------------------
-- |
-- Module      :  TestSuite.Queries.Int_VeriT
-- Copyright   :  (c) Levent Erkok
-- License     :  BSD3
-- Maintainer  :  erkokl@gmail.com
-- Stability   :  experimental
--
-- Testing veriT specific interactive features.
-----------------------------------------------------------------------------
{-# LANGUAGE ScopedTypeVariables #-}

module TestSuite.Queries.Int_VeriT (tests)  where
...
tests =
  testGroup "Basics.QueryIndividual"
    [ goldenCapturedIO "query_veriT" $ \rf -> runSMTWith veriT{verbose=True, redirectVerbose=Just rf} q
    ]
